...
using pc4ML.DataStructures;
using pc4ML.Service;

namespace pc4ML.Controllers
{
    public class MLController : Controller
    {
        ...
        public IActionResult PredictTrending(int id)
        {
            ...
            foreach (var producto in _productoService.getTrendingProductos())
            {
                ...
                {
                    userId = id,
                    productid = producto.ProductoId // Asegúrate de que coincide con el nombre de la propiedad en ProductoRating
                });
